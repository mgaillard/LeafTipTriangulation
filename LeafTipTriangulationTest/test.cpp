...
void testTriangulationOnePointGlm(const std::vector<Camera>& cameras, const glm::vec3& point)
{
	// Matrices to project a 3D point to 2D point in viewport coordinates
...
TEST_CASE("Triangulation of one point from 2 views", "[triangulation]")
{
	...
	// Test the triangulation with several points (OpenCV implementation)
	...
	// Test the triangulation with several points (glm implementation)
	testTriangulationOnePointGlm(cameras, glm::vec3(0.1, -0.2, 0.15));
	testTriangulationOnePointGlm(cameras, glm::vec3(0.298, -0.767, -0.881));
	testTriangulationOnePointGlm(cameras, glm::vec3(0.154, 0.715, -0.733));
	testTriangulationOnePointGlm(cameras, glm::vec3(0.339, 0.957, -0.331));
	testTriangulationOnePointGlm(cameras, glm::vec3(-0.346, 0.887, -0.869));
}
